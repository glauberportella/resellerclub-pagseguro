<?php
	...
	/**
	 * Initialize ResellerPagseguro package for PagSeguro integration
	 * @author Glauber Portella <glauberportella@gmail.com>
	 */
	require_once(__DIR__.'/../bootstrap.php');

	// ResellerClub php kit require
...
<?php
		...
		$key = "bMpGJxL7CNh5mUMoZl0NkSRCZnsYbliz"; //replace ur 32 bit secure key , Get your secure key from your Reseller Control panel
		...
		if(verifyChecksum($paymentTypeId, $transId, $userId, $userType, $transactionType, $invoiceIds, $debitNoteIds, $description, $sellingCurrencyAmount, $accountingCurrencyAmount, $key, $checksum))
		{
			...
			$paymentUrl = $payment->createRequestUrl(array(
					'key'						=> $key,
